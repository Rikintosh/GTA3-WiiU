...
CCarCtrl::ChooseCarModel(int32 vehclass)
{
	...
	if (NumOfLoadedCarsOfRating[vehclass] == 0)
		return -1;
	int32 rnd = CGeneral::GetRandomNumberInRange(0l, CarFreqArrays[vehclass][NumOfLoadedCarsOfRating[vehclass] - 1]);
	int32 index = 0;
...
{
	return CarArrays[rating][CGeneral::GetRandomNumberInRange(0l, TotalNumOfCarsOfRating[rating])];
}
