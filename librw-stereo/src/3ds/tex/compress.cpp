...
void
etc1_common(uint8 *src, uint8 **dst, int stride, bool alpha)
{
	...
	/* only real option for online conversion...
	   If I finish the offline converter it will spit out
	   HighQuality etc's in a flash */
